...
def plot_results_from_csv():
    print(f"\n--- Plotting Splay Tree results from {EXPERIMENT_RESULTS_CSV} ---")
    ...
    try:
        ...
        print("Please ensure you have compiled and run the C++ splay_main_experiment.cpp program to generate this file.")
        sys.exit(1)
    ...
    for metric_key in metrics:
        ...
        plt.title(f'Splay Tree - {metric_display_name}')
